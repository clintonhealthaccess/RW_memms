		...
		<div class="main">
			<g:form action="saveAccount" class="simple-list">
					...
					<div class="row">
						...
						<input type="text" class="idle-field" name="organisation" value="${user.organisation}" />
