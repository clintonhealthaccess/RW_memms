...
<ul class="comment-list">
	<g:each in="${order.comments.sort{a,b -> (a.writtenOn < b.writtenOn) ? 1 : -1}}" status="i" var="comment">
		<li>
			...
			<div class="comment-meta"><span class="comment-written-by">${comment.writtenBy.firstname} ${comment.writtenBy.lastname}</span><span class="comment-written-on">${Utils.formatDateWithTime(comment?.writtenOn)}</span></div>
