		  ...
		  <h2><g:message code="user.filter.label" /><a href="#" id="showhide" class="right"><g:message code="entity.show.hide.filter.label" /></a></h2>
			...
			<g:form url="[controller:'user', action:'filter']" method="get" useToken="false" class="filters-box">
                          <ul class="filters-list third">
                             <li>
                               <g:selectFromList name="location.id" label="${message(code:'location.label')}" bean="${filterCmd}" field="location" optionKey="id" multiple="false"
							...
							values="${locations.collect{it.name}}"/>
                              </li>
                              <li>
                          ...
                          <ul class="filters-list third">
                              <li>
                                <g:selectFromList name="role.id" label="${message(code:'roles.label')}" bean="${filterCmd}" field="role" optionKey="id" multiple="false"
							from="${roles}" value="${filterCmd?.role?.id}" values="${roles.collect{it.name}}"/>
                              </li>
                          </ul>
