<table class="items spaced">
	<thead>
		<tr>
			<g:sortableColumn property="dataLocation"  title="${message(code: 'location.label')}" params="[q:q,'dataLocation.id':dataLocation?.id]" />
			<g:sortableColumn property="code"  title="${message(code: 'equipment.code.label')}" params="[q:q,'dataLocation.id':dataLocation?.id]" />
			<g:sortableColumn property="serialNumber"  title="${message(code: 'equipment.serial.number.label')}" params="[q:q,'dataLocation.id':dataLocation?.id]" />
			...
			<g:sortableColumn property="descriptions"  title="${message(code: 'entity.description.label')}" params="[q:q,'dataLocation.id':dataLocation?.id]" />
