...
<ul>
  <li>
      ...
      <label for="statusChanges"><g:message code="reports.inventory.statusChanges.statusChanges"/>:</label>
  ...
  <li>
    <label for="report_type"><g:message code="reports.inventory.statusChanges.statusChangesPeriod"/>:</label>
