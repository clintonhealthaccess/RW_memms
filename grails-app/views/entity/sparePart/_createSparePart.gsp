	...
	<div class="main">
      ...
      <div class="form-section">
      	...
      	<g:if test="${sparePart.id == null}">
    			...
    			from="${equipments}" value="${sparePart?.usedOnEquipment?.id}" values="${equipments.collect{it.type?.serialNumber}}} (${equipments.collect{it.serialNumber}} - [${equipments.collect{it.dataLocation?.type?.names}}])" />
    			</div>
