...
<div class="filters main">
  <h2><g:message code="equipment.filter.label" /><a href="#" id="showhide" class="right"><g:message code="entity.show.hide.filter.label" /></a></h2>
	...
	<g:form url="[controller:'equipmentView', action:'generalExport']" method="get" useToken="false" class="filters-box">
      ...
      <li>
        <g:selectFromList name="equipmentTypeids"
            ...
            values="${filterCmd?.equipmentTypes.collect{it.names + ' ['+ it.code +']'}}"/>
      </li>
      <li>
        <g:selectFromList name="serviceProvidersIds"
      ...
      <li><g:selectFromEnum name="donor" values="${Donor.values()}" field="donor" label="${message(code:'equipment.donor.label')}" /></li>
		...
		<ul class="filters-list third">
      <li>
        <g:selectFromList name="manufacturerids"
            ...
            values="${filterCmd?.manufacturers.collect{it.contact.contactName + ' ['+ it.code +']'}}"/>
      </li>
      <li>
        <g:selectFromList name="calculationLocationids"
          ...
          values="${filterCmd?.calculationLocations*.names}"/>
      </li>
      <li><g:selectFromEnum name="equipmentStatus" values="${Status.values()}" field="equipmentStatus" label="${message(code:'equipment.status.label')}" /></li>
		...
		<ul class="filters-list third">
      <li>
        <g:selectFromList name="supplierids"
      ...
      <li>
        <g:selectFromList name="dataLocationTypeids"
          ...
          values="${dataLocationTypes*.names}"/>
      </li>
