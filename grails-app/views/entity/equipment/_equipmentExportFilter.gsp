			...
			<g:form url="[controller:'equipmentView', action:'generalExport']" method="get" useToken="false" class="filters-box">
				<ul class="filters-list">
					...
					<li><g:selectFromList name="manufacturerids"
							...
							field="manufacturers" optionKey="${filterCmd?.manufacturers? 'id' : null}" multiple="true"
					...
					<li><g:selectFromList name="supplierids"
							...
							field="suppliers" optionKey="${filterCmd?.suppliers? 'id' : null}" multiple="true"
					...
					<li><g:selectFromList name="dataLocationTypeids"
							...
							field="dataLocationTypes" optionKey="id" multiple="true"
