  ...
  <div id="list-grid" class="v-tabs">
    ...
    <div class="v-tabs-content right">
      <ul class="v-tabs-filters">
        <li><input type="checkbox" name="green" checked="checked"/><label>Green</label></li>
        <li><input type="checkbox" name="yellow" checked="checked"/><label>Yellow</label></li>
        <li><input type="checkbox" name="red" checked="checked"/><label>Red</label></li>
      </ul>
