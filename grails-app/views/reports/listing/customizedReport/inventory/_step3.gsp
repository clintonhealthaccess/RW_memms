...
<ul class="onecol-checkboxes right">
	...
	<li><g:checkBox name="reportTypeOptions" value="manufacturer" /><span>${message(code:'listing.report.equipment.manufacturer.label')}</span></li>
	...
	<g:if test="${reportSubType == ReportSubType.STATUSCHANGES}">
		<li><g:checkBox name="reportTypeOptions" value="statusChanges" /><span>${message(code:'listing.report.equipment.status.changes.label')}</span></li>
	</g:if>
