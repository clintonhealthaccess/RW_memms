...
<ul class="onecol-checkboxes left">
	<g:if test="${[ReportSubType.INVENTORY,ReportSubType.STATUSCHANGES].contains(reportSubType)}">
		<li><g:checkBox name="reportTypeOptions" value="model" checked="false" /><span>${message(code:'listing.report.spare.part.model.label')}</span></li>
		<li><g:checkBox name="reportTypeOptions" value="manufacturer" checked="false" /><span>${message(code:'listing.report.spare.part.manufacturer.label')}</span></li>
...
<ul class="onecol-checkboxes right">
	...
	<li><g:checkBox name="reportTypeOptions" value="quantityInStock" /><span>${message(code:'listing.report.spare.part.quantity.in.stock.label')}</span></li>
	<li><g:checkBox name="reportTypeOptions" value="currentStatus" /><span>${message(code:'listing.report.spare.part.status.label')}</span></li>
