  ...
  <div id ="list-grid" class="v-tabs">
    ...
    <div id='js-inventory' class="v-tabs-content right shown">
      <ul class="v-tabs-subnav">
      	<li>
      	<a class="active" href="${createLinkWithTargetURI(controller: 'listing', action:'listEquipments')}" id="report-1">
		...
		<li>
		<a href="${createLinkWithTargetURI(controller: 'listing', action:'searchEquipmentsByCriteria')}" id="report-6">
