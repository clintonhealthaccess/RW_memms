      ...
      <ul id="main-menu" class="menu">
        ...
        <shiro:hasPermission permission="menu:admin">
          <li><a href="#"><g:message code="header.navigation.administration"/></a>
            <ul class="submenu">
              <shiro:hasPermission permission="menu:dashboardConfig">
                <li><a href="#"><g:message code="header.navigation.reports.dashboard"/></a>
                  <div class="sub-submenu">
                    <ul class="submenu">
                      <li><a href="${createLink(controller: 'indicator', action:'list')}"><g:message code="indicator.label"/></a></li>
                      <li><a href="${createLink(controller: 'indicatorCategory', action:'list')}"><g:message code="indicatorCategory.label"/></a></li>
                      <li><a href="${createLink(controller: 'userDefinedVariable', action:'list')}"><g:message code="userDefinedVariable.label"/></a></li>
                    </ul>
                  </div>
                </li>
              </shiro:hasPermission>
